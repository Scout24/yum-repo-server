...
![Image of intended usage of the yum-repo-server](/ImmobilienScout24/yum-repo-server/blob/master/docs/yrs_usecase.png "Intended usage of the yum-repo-server")
